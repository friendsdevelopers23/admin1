...
@Metadata(mv = { 1, 1, 16 }, bv = { 1, 0, 3 }, k = 1, d1 = {
		"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\t\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B1\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\b\u0010\u0005\u001a\u0004\u0018\u00010\u0003\u0012\u0006\u0010\u0006\u001a\u00020\u0003\u0012\b\u0010\u0007\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\bR\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\t\u0010\n\"\u0004\b\u000b\u0010\fR\u001c\u0010\u0004\u001a\u0004\u0018\u00010\rX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000e\u0010\u000f\"\u0004\b\u0010\u0010\u0011R\u001c\u0010\u0006\u001a\u0004\u0018\u00010\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0012\u0010\n\"\u0004\b\u0013\u0010\f¨\u0006\u0014" }, d2 = {
				"Lcom/example/above18/SearchCriteria;", "", "key", "", "operation", "prefix", "value", "suffix",
				"(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V",
				"getKey", "()Ljava/lang/String;", "setKey", "(Ljava/lang/String;)V",
				"Lcom/example/above18/SearchOperation;", "getOperation", "()Lcom/example/above18/SearchOperation;",
				"setOperation", "(Lcom/example/above18/SearchOperation;)V", "getValue", "setValue", "above18" })
public final class SearchCriteria {
	...
	@Nullable
	private String value1; // value1 for between operation
	@Nullable
	...
	public SearchCriteria(@NotNull String key, @NotNull String operation, @Nullable String prefix,
			@NotNull String value, @Nullable String suffix) {
		super();
		...
		if (op != null) {
			boolean startsWithAsterisk = prefix != null
					&& prefix.contains((CharSequence) SearchOperation.Companion.getZERO_OR_MORE_REGEX());
			boolean endsWithAsterisk = suffix != null
					&& suffix.contains((CharSequence) SearchOperation.Companion.getZERO_OR_MORE_REGEX());

			if (op == SearchOperation.EQUALS && value.contains("~")) {
			...
			else if (op == SearchOperation.EQUALS && startsWithAsterisk && endsWithAsterisk) {
